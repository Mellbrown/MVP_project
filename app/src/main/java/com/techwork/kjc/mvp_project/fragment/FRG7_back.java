...
public class FRG7_back extends android.support.v4.app.Fragment {
   ...
   private ImageView act7_first;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.raw.body1).into(first);
        Glide.with(this).load(R.raw.body2).into(second);
        Glide.with(this).load(R.raw.body3).into(third);
        Glide.with(this).load(R.raw.body4).into(fource);
