...
public class FRG7_Leg extends android.support.v4.app.Fragment {
   ...
   private ImageView act7_first;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.raw.leg1).into(first);
        Glide.with(this).load(R.raw.leg2).into(second);
        Glide.with(this).load(R.raw.leg3).into(third);
        Glide.with(this).load(R.raw.leg4).into(fource);
